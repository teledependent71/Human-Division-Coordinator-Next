...
import booksPageInitialPaths407efResource from '../../../resources/books-page-initial-paths-407ef'
import booksPageInitialPropsD215fResource from '../../../resources/books-page-initial-props-d215f'
...
export async function getStaticPaths() {
  const response = await booksPageInitialPaths407efResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await booksPageInitialPropsD215fResource({
      ...context?.params,
